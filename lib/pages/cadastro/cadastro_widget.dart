...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.txtIdadeTextController ??= TextEditingController();
    _model.txtIdadeFocusNode ??= FocusNode();

    _model.txtSaudeTextController ??= TextEditingController();
    _model.txtSaudeFocusNode ??= FocusNode();

    _model.txtTelefoneTextController ??= TextEditingController();
    _model.txtTelefoneFocusNode ??= FocusNode();

    _model.txtOcupacaoTextController ??= TextEditingController();
    _model.txtOcupacaoFocusNode ??= FocusNode();
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 10.0),
                            child: TextFormField(
                              controller: _model.txtIdadeTextController,
                              focusNode: _model.txtIdadeFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Idade',
                              ...
                              validator: _model.txtIdadeTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 10.0),
                            child: TextFormField(
                              controller: _model.txtSaudeTextController,
                              focusNode: _model.txtSaudeFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText:
                              ...
                              validator: _model.txtSaudeTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 10.0),
                            child: TextFormField(
                              controller: _model.txtOcupacaoTextController,
                              focusNode: _model.txtOcupacaoFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Ocupação',
                              ...
                              validator: _model
                                  .txtOcupacaoTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          8.0, 15.0, 8.0, 5.0),
                                      child: Text(
                                        'Se sim, a quanto tempo pratica esta atividade?',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await CadastroTable().insert({
                                    ...
                                    'idade': _model.txtIdadeTextController.text,
                                    'email': _model.txtEmailTextController.text,
                                    'ocupacao':
                                        _model.txtOcupacaoTextController.text,
                                    'pratica_atividade':
                                        _model.radioButtonValue,
                                    'doenca':
                                        _model.txtSaudeTextController.text,
                                    'contato':
                                        _model.txtTelefoneTextController.text,
                                    'tempo_atividade': _model.dropDownValue,
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: const Text('Funcionamento ok'),
                                        actions: [
                                          TextButton(
