...
class DojoConnectSupabaseUser extends BaseAuthUser {
  DojoConnectSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> dojoConnectSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = DojoConnectSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
