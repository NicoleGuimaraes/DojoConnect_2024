...
import 'quest_part2_copy_model.dart';
export 'quest_part2_copy_model.dart';

class QuestPart2CopyWidget extends StatefulWidget {
  const QuestPart2CopyWidget({super.key});

  @override
  State<QuestPart2CopyWidget> createState() => _QuestPart2CopyWidgetState();
}

class _QuestPart2CopyWidgetState extends State<QuestPart2CopyWidget>
    with TickerProviderStateMixin {
  late QuestPart2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuestPart2CopyModel());
